...
umd.output.filename = "./dist/seng-disposable-umd.js";

var umdMin = baseConfig();
umdMin.output.libraryTarget = "umd";
umdMin.output.filename = "./dist/seng-disposable-umd.min.js";
...
amd.output.filename = "./dist/seng-disposable-amd.js";


var cjs2 = baseConfig();
delete cjs2.output.library;
cjs2.output.libraryTarget = "commonjs2";
cjs2.output.filename = "./dist/seng-disposable-commonjs.js";
...
system.plugins.push(
	...
	new WebpackSystemRegister({
		...
		registerName: 'seng-disposable', // optional name that SystemJS will know this bundle as.
	})
);
system.output.filename = "./dist/seng-disposable-systemjs.js";


var browser = baseConfig();
browser.output.libraryTarget = "var";
browser.output.filename = "./dist/seng-disposable.js";


var browserMin = baseConfig();
browserMin.output.libraryTarget = "var";
browserMin.output.filename = "./dist/seng-disposable.min.js";
